	...
	class MyButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(source == b1) {
				...
				System.out.println("위치: " + b1.getX() + ", " + b1.getY() + "/ 크기: " + b1.getWidth() + ", " + b1.getHeight());
				JPanel c = (JPanel) b1.getParent();
				System.out.println("컨텐트팬의 위치와 크기");
				System.out.println("위치: " + c.getX() + ", " + c.getY() + "/ 크기: " + c.getWidth() + ", " + c.getHeight());
				
			} else if(source == b2) {
				System.out.println("모양 정보");
